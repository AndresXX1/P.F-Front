...
useEffect(() => {
    ...
    dispatch(getSneakers(currentPage, pageSize, brandFilter, colorFilter, sizeFilter));
...
<select value={colorFilter} onChange={e => setColorFilter(e.target.value)}>
  {colors.map(colorOption => (
    <option key={colorOption.value} value={colorOption.value}>{colorOption.label}</option>
        ...
        <input type="text" placeholder="Busque aquí por nombre..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
      </div>
