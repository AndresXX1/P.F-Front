...
import {fetchProductDetail,clearProductDetail,postCartItems,getSneakers,setSelectedImageIndex} from "../../redux/actions/actions";
    ...
    <div className={style.container}>
      ...
      <div className={style.detailContainer}>
        <div className={style.imagePreview}>
          <img
            src={setSelectedImageIndex.length > 0 ? setSelectedImageIndex : (zapatilla && zapatilla.image.secure_url || zapatilla.image[0].secure_url)}
            alt={zapatilla.name}
          />
        </div>
